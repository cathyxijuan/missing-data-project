...
d1 <- cbind(fitNoMissingShort_CR2_1[[2]], fitNoMissingShort_CR2_1[[1]][,"rmsea"])
colnames(d1) <- names
d1
...
#################
d2 <- cbind(fitMCAR_Short_CR2_1[[9]],fitMCAR_Short_CR2_1[[1]][,"rmsea"])
colnames(d2) <- names
d2
...
#######
d3 <-  cbind(fitMCAR_Short_CR2_1[[10]],fitMCAR_Short_CR2_1[[2]][,"rmsea"])
colnames(d3) <- names
d3
...
#######
d5 <-  cbind(fitMCAR_Short_CR2_1[[13]],fitMCAR_Short_CR2_1[[5]][,"rmsea"])
colnames(d5) <- names
d5
...
#########
d6 <-  cbind(fitMCAR_Short_CR2_1[[14]],fitMCAR_Short_CR2_1[[6]][,"rmsea"])
colnames(d6) <- names
d6
...
################
fitMAR_Linear_Short_CR2_1[9]
fitMAR_Linear_Short_CR2_1[1]



d8 <- cbind(fitMAR_Linear_Short_CR2_1[[9]],fitMAR_Linear_Short_CR2_1[[1]][,"rmsea"])
colnames(d8) <- names
d8
...
####
################
fitMAR_Linear_Short_CR2_1[10]
fitMAR_Linear_Short_CR2_1[2]

d9 <- cbind(fitMAR_Linear_Short_CR2_1[[10]],fitMAR_Linear_Short_CR2_1[[2]][,"rmsea"])
colnames(d9) <- names
d9
...
fitMAR_Linear_Short_CR2_1[13]
fitMAR_Linear_Short_CR2_1[5]



d11 <- cbind(fitMAR_Linear_Short_CR2_1[[13]],fitMAR_Linear_Short_CR2_1[[5]][,"rmsea"])
colnames(d11) <- names
d11
...
##########
fitMAR_Linear_Short_CR2_1[14]
fitMAR_Linear_Short_CR2_1[6]

d12 <- cbind(fitMAR_Linear_Short_CR2_1[[14]],fitMAR_Linear_Short_CR2_1[[6]][,"rmsea"])
colnames(d12) <- names
d12
...
######
fitMAR_Linear_Short_CR2_1[11]
fitMAR_Linear_Short_CR2_1[3]



d14 <- cbind(fitMAR_Linear_Short_CR2_1[[11]],fitMAR_Linear_Short_CR2_1[[3]][,"rmsea"])
colnames(d14) <- names
d14
...
##########
fitMAR_Linear_Short_CR2_1[12]
fitMAR_Linear_Short_CR2_1[4]

d15 <- cbind(fitMAR_Linear_Short_CR2_1[[12]],fitMAR_Linear_Short_CR2_1[[4]][,"rmsea"])
colnames(d15) <- names
d15
...
fitMAR_Linear_Short_CR2_1[15]
fitMAR_Linear_Short_CR2_1[7]

d17 <- cbind(fitMAR_Linear_Short_CR2_1[[15]],fitMAR_Linear_Short_CR2_1[[7]][,"rmsea"])
colnames(d17) <- names
d17
...
####
fitMAR_Linear_Short_CR2_1[16]
fitMAR_Linear_Short_CR2_1[8]



d18 <- cbind(fitMAR_Linear_Short_CR2_1[[16]],fitMAR_Linear_Short_CR2_1[[8]][,"rmsea"])
colnames(d18) <- names
d18
