...
fitNoMissing_CR2_4 <- fit.indices.comp
sigmaHat_CR2_4 <- sigma.hat
sigma_CR2_4 <-sigma

save(fitNoMissing_CR2_4, file="fitNoMissing_CR2_4.RData")
save(sigmaHat_CR2_4, file="sigmaHat_CR2_4.RData")
save(sigma_CR2_4, file="sigma_CR2_4.RData")