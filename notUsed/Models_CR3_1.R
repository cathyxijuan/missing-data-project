...
fitNoMissing_CR3_1 <- fit.indices.comp
sigmaHat_CR3_1 <- sigma.hat
sigma_CR3_1 <-sigma

save(fitNoMissing_CR3_1, file="fitNoMissing_CR3_1.RData")
save(sigmaHat_CR3_1 , file="sigmaHat_CR3_1.RData")
save(sigma_CR3_1 , file="sigma_CR3_1.RData")