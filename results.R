...
load("fitMAR_Short_CR1_3.RData")
load("fitMAR_Short_CR2_1.RData")
load("fitMAR_Short_CR2_3.RData")
load("fitMAR_maxPat_Short_WM.RData")
load("fitMAR_minPat_Short_WM.RData")
