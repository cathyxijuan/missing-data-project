...
sigmaHat_MCAR_MinPat_20PerMiss_4VarMiss_CR1_1 <- sigma.hat.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, missing.percentage = 0.20, missing.type = "min")

sigmaHat_MCAR_MinPat_50PerMiss_4VarMiss_CR1_1 <- sigma.hat.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, missing.percentage = 0.50, missing.type = "min")



fitMCAR_MinPat_20PerMiss_4VarMiss_CR1_1 <- fit.ind.matrix.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, missing.percentage = 0.20, missing.type = "min")


fitMCAR_MinPat_50PerMiss_4VarMiss_CR1_1  <- fit.ind.matrix.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, missing.percentage = 0.50, missing.type = "min")


round(fitMCAR_MinPat_20PerMiss_4VarMiss_CR1_1,6) 

round(fitMCAR_MinPat_50PerMiss_4VarMiss_CR1_1,6)

save(sigmaHat_MCAR_MinPat_20PerMiss_4VarMiss_CR1_1, file="sigmaHat_MCAR_MinPat_50PerMiss_4VarMiss_CR1_1.RData")
save(sigmaHat_MCAR_MinPat_50PerMiss_4VarMiss_CR1_1, file="sigmaHat_MCAR_MinPat_50PerMiss_4VarMiss_CR1_1.RData")
save(fitMCAR_MinPat_20PerMiss_4VarMiss_CR1_1, file="fitMCAR_MinPat_20PerMiss_4VarMiss_CR1_1.RData")
save(fitMCAR_MinPat_50PerMiss_4VarMiss_CR1_1, file="fitMCAR_MinPat_50PerMiss_4VarMiss_CR1_1.RData")
