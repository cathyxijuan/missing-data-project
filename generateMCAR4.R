...
sigmaHat_MCAR_20Missing_MinPat_CR2_2 <- sigma.hat.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, missing.percentage = 0.20, missing.type = "min")

sigmaHat_MCAR_50Missing_MinPat_CR2_2 <- sigma.hat.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, missing.percentage = 0.50, missing.type = "min")



fitMCAR_20Missing_MinPat_CR2_2 <- fit.ind.matrix.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, missing.percentage = 0.20, missing.type = "min")


fitMCAR_50Missing_MinPat_CR2_2 <- fit.ind.matrix.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, missing.percentage = 0.50, missing.type = "min")


round(fitMCAR_20Missing_MinPat_CR2_2,6) 

round(fitMCAR_50Missing_MinPat_CR2_2,6)

# save(fitMCAR_20Missing_MinPat_CR2_2, file="fitMCAR_20Missing_MinPat_CR2_2.RData")
# save(fitMCAR_50Missing_MinPat_CR2_2, file="fitMCAR_50Missing_MinPat_CR2_2.RData")
# save(sigmaHat_MCAR_20Missing_MinPat_CR2_2, file="sigmaHat_MCAR_20Missing_MinPat_CR2_2.RData")
# save(sigmaHat_MCAR_50Missing_MinPat_CR2_2, file="sigmaHat_MCAR_50Missing_MinPat_CR2_2.RData")
