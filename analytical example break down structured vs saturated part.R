...
#break down the structured and saturated parts
fmin.comp <- log(det(sigma.not)) + sum(diag(sigma%*%solve(sigma.not))) +
  t(mu-mu.not)%*%solve(sigma.not)%*%(mu-mu.not) -(log(det(sigma)) +p)
fmin.comp #struct=4.28462, saturated =3.472581
...
#break down struct vs sat parts

fmin.mcar.case2 <- 0.8*(log(det(sigma.not.pattern1)) + 
                          sum(diag(sigma.pattern1%*%solve(sigma.not.pattern1))) +
                          t(mu.pattern1-mu.not.pattern1)%*%solve(sigma.not.pattern1)%*%(mu.pattern1-mu.not.pattern1))+
  0.2*(log(det(sigma.not.pattern2)) + 
         sum(diag(sigma.pattern2%*%solve(sigma.not.pattern2))) +
         t(mu.pattern2-mu.not.pattern2)%*%solve(sigma.not.pattern2)%*%(mu.pattern2-mu.not.pattern2))-
  (0.2*log(det(sigma.pattern2))+0.8*log(det(sigma.pattern1))+0.8*p.pattern1+0.2*p.pattern2)

fmin.mcar.case2 #stru=4.1625 #sat=3.350385 both decreased but decreased by the same amount relative to the complete
...
fmin.mcar.case3 <- 0.8*(log(det(sigma.not.pattern1)) + 
                          sum(diag(sigma.pattern1%*%solve(sigma.not.pattern1))) +
                          t(mu.pattern1-mu.not.pattern1)%*%solve(sigma.not.pattern1)%*%(mu.pattern1-mu.not.pattern1))+
  0.2*(log(det(sigma.not.pattern2)) + 
         sum(diag(sigma.pattern2%*%solve(sigma.not.pattern2))) +
...
fmin.mcar.case3 #stru=4.240064 #sat=3.590432 relative to complete, sat increased and struc decreased
